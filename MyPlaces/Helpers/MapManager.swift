...
//  MyPlaces
//
//  Created by Artur Anissimov on 09.02.2020.
...
class MapManager {
    ...
    func setupPlacemark(place: Place, mapView: MKMapView) {
        ...
        geocoder.geocodeAddressString(location) { (placemarks, error) in
            ...
            mapView.selectAnnotation(annotation, animated: true) // Select our location mark
    ...
    // Меняем отображаемую зону области карты в соответствии с перещением пользователя
